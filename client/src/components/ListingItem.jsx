    ...
    <div className="bg-white shadow-md hover:shadow-lg transition:shadow duration-300 overflow-hidden rounded-lg w-full sm:w-[330px]">
      <Link to={`/listing/${listing._id}`}>
        <img
          ...
          src={
            listing.imageUrls[0] ||
            "https://www.investopedia.com/thmb/OQxvtmsJwBCy6kVw86E-ooDRVqs=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/rent_house_73089751-5bfc333346e0fb002602ddbe.jpg"
          }
          alt="listing-cover"
        />
        <div className="flex flex-col gap-3 p-3">
          ...
          <div className="textsm text-gray-600 line-clamp-2">
