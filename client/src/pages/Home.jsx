...
const Home = () => {
  ...
  const [rentLisings, setRentListings] = useState([]);
    ...
    <div className="">
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gray-400 text-xs sm:text-sm">
          E-state is the best place to find your next perfect place to live.{" "}
          <br />
      ...
      <div className="max-w-6xl mx-auto p-3 flex flex-col gap-8 my-10">
        ...
        {rentLisings && rentLisings.length > 0 && (
          <div className="">
            <div className="my-3">
